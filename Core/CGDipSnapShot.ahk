...
;targetwindow := "BlueStacks 1"
;WinGet, testH1,ID,%targetwindow%
;CGDipSnapShot.TakeSnapshot()
;CGDipSnapShot.ShowSnapshot(testH1)
...
Class CGDipSnapShot {
	...
	TakeSnapshot(){
		...
		this.pBitmap := Gdip_BitmapFromHWND(hwnd := WinExist("" targetwindow ""  ))
