...
RoomSelect()
{
		...
		exist:=BotItScanner("BotitFoodT",65,"Single","G",1)
		if exist{
		...
		else
		{
			...
			BotItScanner("BotitFoodSG",65,"Single","G",1)
			Sleep, %SleepAmount%
			Sleep, %SleepAmount%
		}
		...
		if exist
		{
			...
			BotItScanner("BotitNoFood",65,"Single","G",1)
		...
		exist:=BotItScanner("BotitNext3",65,"Single","G",1)
		if exist
		{
			...
			Sleep, %SleepAmount%
			Sleep, %SleepAmount%
			BotItScanner("BotitNext3b",65,"Single","G",1)
		}
