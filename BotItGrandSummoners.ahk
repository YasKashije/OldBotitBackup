...
;# Gui Main
{
	...
	Grabber_TT := "Left Click on the window to attach to, Left Click Target Window Window After MSG Gone"
	Gui Font, Bold s10
	...
	Gui Show, w400 h400, Botit Grand Summoners v0.2.3
	Menu, Tray, Icon, Core\favicon.png
...
if IsPaused
{
	...
	Grab:
	msgbox,,, Left Click on the window to attach to,2
	KeyWait, LButton, D
	{
